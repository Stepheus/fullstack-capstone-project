                ...
                <div className="col-md-6 col-lg-4">
                    <div className="register-card p-4 border rounded">
                        ...
                        <div className="mb-4">
                            ...
                            <input id="lastName" type="text" className="form-control" placeholder="Enter your lastname" value={lasttName}
                            ...
                            <input id="password" type="text" className="form-control" placeholder="Enter your password" value={password}
